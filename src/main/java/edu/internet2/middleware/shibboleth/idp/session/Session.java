...
public interface Session extends edu.internet2.middleware.shibboleth.common.session.Session {
    ...
    public void addServicesInformation(String key, ServiceInformation value);
    public void addAuthenticationMethods(String key, AuthenticationMethodInformation value);
    public void remoteAuthenticationMethods(String key);
