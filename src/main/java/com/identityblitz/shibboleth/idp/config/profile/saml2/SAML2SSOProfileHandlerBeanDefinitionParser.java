...
package com.identityblitz.shibboleth.idp.config.profile.saml2;

import com.identityblitz.shibboleth.idp.config.profile.ProfileHandlerNamespaceHandler;
import com.identityblitz.shibboleth.idp.profile.saml2.SSOProfileHandlerExtended;
...
/**
 * Spring bean definition parser for {@link edu.internet2.middleware.shibboleth.idp.profile.saml2.SSOProfileHandler} profile handlers.
 */
public class SAML2SSOProfileHandlerBeanDefinitionParser extends AbstractSAML2ProfileHandlerBeanDefinitionParser {
    ...
    protected Class getBeanClass(Element arg0) {
        return SSOProfileHandlerExtended.class;
    }
