package com.blitz.idm.idp.config.atr.filtering.match;
...
import com.blitz.idm.idp.config.atr.filtering.provider.match.AttributeInAuthorityAttributesMatchFunctor;
